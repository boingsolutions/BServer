...
COMMENT ON TABLE config IS 'BServer';
...
COMMENT ON TABLE identity IS 'BServer';
...
COMMENT ON TABLE level IS 'BServer';
...
COMMENT ON TABLE menu IS 'BServer';
...
COMMENT ON TABLE income IS 'BServer';
...
COMMENT ON TABLE packet IS 'BServer';
...
COMMENT ON TABLE payment IS 'BServer';
...
COMMENT ON TABLE themes IS 'BServer';
...
COMMENT ON TABLE type IS 'BServer';
...
COMMENT ON TABLE users IS 'BServer';
